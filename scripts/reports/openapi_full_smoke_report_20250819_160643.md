# OpenAPI Full Smoke Report (20250819_160643)
...
- POST /api/v1/admin/subscription-plans/ -> FAILED (500) - HTTP 500: Internal Server Error
...
- POST /api/v1/forum/posts/ -> PASSED (201) 
...
- GET /api/v1/users/me -> FAILED (-) - ('Connection aborted.', ConnectionResetError(104, 'Connection reset by peer'))
...
- GET /api/v1/users/certificates/ -> FAILED (-) 
- GET /api/v1/users/certificates/{certificate_id} -> PASSED (200) 
...
- GET /api/v1/statistics/payment-stats -> FAILED (-) 
- GET /api/v1/user-progress/ -> PASSED (200) 
- POST /api/v1/user-progress/lessons/{lesson_id}/complete -> PASSED (200) 
