# OpenAPI Full Smoke Report (20250819_193140)
...
- PUT /api/v1/admin/courses/{course_id} -> SKIPPED (404) - Resurs topilmadi (404)
- DELETE /api/v1/admin/courses/{course_id} -> SKIPPED (404) - Resurs topilmadi (404)
...
- PUT /api/v1/admin/subscription-plans/{plan_id} -> SKIPPED (404) - Resurs topilmadi (404)
- DELETE /api/v1/admin/subscription-plans/{plan_id} -> SKIPPED (404) - Resurs topilmadi (404)
...
- PATCH /api/v1/admin/users/{user_id} -> FAILED (500) - HTTP 500: Internal Server Error
...
- POST /api/v1/notifications/admin/send -> FAILED (500) - HTTP 500: Internal Server Error
...
- PATCH /api/v1/words/{id} -> PASSED (200) 
...
- PUT /api/v1/admin/tests/sections/{section_id} -> FAILED (404) 
- DELETE /api/v1/admin/tests/sections/{section_id} -> FAILED (404) 
